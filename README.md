...
- Quản lý tài liệu bệnh án tối thiểu: tạo bản nháp, ký tài liệu, xuất metadata sang FHIR `DocumentReference` và xuất FHIR `Provenance` cho tài liệu đã ký để mô tả người chịu trách nhiệm, thời điểm ký/xác nhận và nguồn tài liệu.
