...
- `clinician`: thực hiện nghiệp vụ điều trị, tạo bệnh nhân, mở lượt khám, ghi nhận dị ứng/cảnh báo, chẩn đoán/chỉ định dịch vụ/chỉ số/chỉ định thuốc, tạo/ký tài liệu và xuất FHIR phục vụ điều trị.
- `nurse`: đọc bệnh nhân, đọc/tạo tài liệu, ghi nhận dị ứng/cảnh báo, chẩn đoán/chỉ định dịch vụ/chỉ số/chỉ định thuốc, nhưng không ký và không xuất FHIR.
