...
- `clinician`: thực hiện nghiệp vụ điều trị, đọc/xuất Provider Directory, tạo bệnh nhân, mở lượt khám, ghi nhận dị ứng/cảnh báo, chẩn đoán/chỉ định dịch vụ/công việc thực thi/chỉ số/báo cáo kết quả/nghiên cứu hình ảnh/chỉ định thuốc, tạo/ký tài liệu và xuất FHIR phục vụ điều trị.
- `nurse`: đọc Provider Directory, đọc bệnh nhân, đọc/tạo tài liệu, ghi nhận dị ứng/cảnh báo, chẩn đoán/chỉ định dịch vụ/công việc thực thi/chỉ số/báo cáo kết quả/nghiên cứu hình ảnh/chỉ định thuốc, nhưng không ký và không xuất FHIR.
