...
- `scripts/harness/release-workflow.mjs`: kiểm tra workflow release chỉ publish GHCR image theo semantic version, không publish tag `latest`, và giữ quyền workflow tối thiểu.
