...
- `scripts/harness/repo-governance.mjs`: kiểm tra CODEOWNERS bao phủ vùng lâm sàng/vận hành nhạy cảm và PR template vẫn yêu cầu CI, tác động API/domain/Docker, bảo mật dữ liệu, FHIR/DICOM/audit/phân quyền và rủi ro còn lại.
