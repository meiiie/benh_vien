...
Các lỗi không được xử lý riêng sẽ đi qua error envelope tập trung. Lỗi validation trả `400 VALIDATION_ERROR`; lỗi nội bộ trả `500 INTERNAL_SERVER_ERROR`; cả hai đều có `requestId` và không trả stack trace cho client.
