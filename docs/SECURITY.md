...
- CODEOWNERS và PR template được kiểm bằng `harness:repo-governance` để các vùng lâm sàng/vận hành nhạy cảm như domain, API, migration, CI, compose, chuẩn y tế và runbook không mất review owner hoặc câu hỏi tuân thủ tối thiểu.
