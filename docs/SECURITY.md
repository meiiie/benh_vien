...
- `RecordTransfer` kiểm consent trước khi tạo, ghi audit khi liệt kê/tạo/xem/gửi/lỗi/thử lại/xác nhận nhận/xuất FHIR `Task`, và không lưu bản sao đầy đủ của Bundle trong bảng vận hành.
