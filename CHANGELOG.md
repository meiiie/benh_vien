...
- Mở rộng rào ABAC theo bệnh nhân sang `ClinicalDocument`, `Observation` và `RecordTransfer` để chặn list/read/export/update khi người dùng điều trị không thuộc tổ chức quản lý hồ sơ.
