...
- Bổ sung metadata toàn vẹn cho tệp tài liệu bệnh án, gồm MIME type, dung lượng, SHA-1 Base64, thời điểm tạo tệp, migration PostgreSQL và ánh xạ sang FHIR `DocumentReference.content.attachment`.
