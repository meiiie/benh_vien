...
assets/
  ...
  backgrounds/  Nền trừu tượng dùng để dựng social preview/banner
evaluation/     Scorecard và tiêu chí chấm
prompts/        Prompt dùng cho imagegen
research/       Ghi chú nghiên cứu nguồn chính thống
scripts/        Script render asset chính thức từ nền, logo và typography
...
- Quyết định OG/banner vòng 2: [evaluation/og-banner-round-02.md](evaluation/og-banner-round-02.md).
- Script render chính thức: [scripts/render-social-assets.ps1](scripts/render-social-assets.ps1).
