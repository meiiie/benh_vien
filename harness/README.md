...
- Kiểm tra biên kiến trúc frontend: `App.tsx` không phình to, HTTP đi qua API client, formatter không bị gom lẫn miền, type lâm sàng phải import từ module nghiệp vụ chuyên biệt thay vì barrel tương thích `types/clinical.ts`, và UI chuyển hồ sơ không gom ngược delivery-attempt/tóm tắt vận hành vào panel chính.
