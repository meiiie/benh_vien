...
- Kiểm tra biên test API: test login/token nằm trong file riêng, test helper auth dùng chung không phình thành nơi chứa scenario, và suite auth/RBAC chính không nuốt ngược test login.
