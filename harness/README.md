...
- Kiểm tra biên test API: test login/token và runtime/readiness/security envelope nằm trong file riêng, test helper auth dùng chung không phình thành nơi chứa scenario, và suite auth/RBAC chính không nuốt ngược các nhóm này.
