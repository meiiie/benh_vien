...
- Kiểm tra biên test API: test login/token, runtime/readiness/security envelope và startup/production config nằm trong file riêng, test helper auth dùng chung không phình thành nơi chứa scenario, và suite auth/RBAC chính không nuốt ngược các nhóm này.
