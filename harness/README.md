...
- Kiểm tra biên kiến trúc domain: `RecordTransfer`, `ProviderDirectory`, `AuditEvent` và `AccessControl` giữ behavior tách khỏi type, snapshot, command input/code set, role-purpose-permission catalog.
